			...
			namespace Protocol {
				namespace DataArray {
					struct PutDataArraysResponse {
						...
						static constexpr int protocolId = static_cast<int>(Energistics::Etp::v12::Datatypes::Protocol::DataArray);
					};
				}
			}
		}
			...
			namespace Protocol {
				namespace Transaction {
					struct StartTransaction {
						...
						static constexpr int messageTypeId=1;
						static constexpr int protocolId = static_cast<int>(Energistics::Etp::v12::Datatypes::Protocol::Transaction);
					};
				}
			}
		}
